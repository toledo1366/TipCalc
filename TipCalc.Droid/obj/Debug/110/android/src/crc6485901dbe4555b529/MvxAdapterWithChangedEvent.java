...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_getAutofillOptions:()[Ljava/lang/CharSequence;:GetGetAutofillOptionsHandler:Android.Widget.IAdapter, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n" +
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapterWithChangedEvent, MvvmCross", MvxAdapterWithChangedEvent.class, __md_methods);
	}
	...
	public MvxAdapterWithChangedEvent ()
	{
		...
		if (getClass () == MvxAdapterWithChangedEvent.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapterWithChangedEvent, MvvmCross", "", this, new java.lang.Object[] {  });
	}
	...
	public MvxAdapterWithChangedEvent (android.content.Context p0)
	{
		super ();
		if (getClass () == MvxAdapterWithChangedEvent.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapterWithChangedEvent, MvvmCross", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	{
		return n_getAutofillOptions ();
	}

	private native java.lang.CharSequence[] n_getAutofillOptions ();
