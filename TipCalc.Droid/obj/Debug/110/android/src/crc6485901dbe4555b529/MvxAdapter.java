...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapter, MvvmCross", MvxAdapter.class, __md_methods);
	}
	...
	public MvxAdapter ()
	{
		...
		if (getClass () == MvxAdapter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapter, MvvmCross", "", this, new java.lang.Object[] {  });
	}
	...
	public MvxAdapter (android.content.Context p0)
	{
		super ();
		if (getClass () == MvxAdapter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapter, MvvmCross", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
