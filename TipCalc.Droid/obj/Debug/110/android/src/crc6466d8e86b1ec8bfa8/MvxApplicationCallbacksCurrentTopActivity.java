...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Views.MvxApplicationCallbacksCurrentTopActivity, MvvmCross", MvxApplicationCallbacksCurrentTopActivity.class, __md_methods);
	}


	public MvxApplicationCallbacksCurrentTopActivity ()
	{
		super ();
		if (getClass () == MvxApplicationCallbacksCurrentTopActivity.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Views.MvxApplicationCallbacksCurrentTopActivity, MvvmCross", "", this, new java.lang.Object[] {  });
	}
