...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter+MyFilter, MvvmCross", MvxFilteringAdapter_MyFilter.class, __md_methods);
	}
	...
	public MvxFilteringAdapter_MyFilter ()
	{
		...
		if (getClass () == MvxFilteringAdapter_MyFilter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter+MyFilter, MvvmCross", "", this, new java.lang.Object[] {  });
	}

	public MvxFilteringAdapter_MyFilter (crc6485901dbe4555b529.MvxFilteringAdapter p0)
	{
		super ();
		if (getClass () == MvxFilteringAdapter_MyFilter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter+MyFilter, MvvmCross", "MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter, MvvmCross", this, new java.lang.Object[] { p0 });
	}
